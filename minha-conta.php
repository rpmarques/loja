...
if ($cliente = $objClientes->pegaCliente($id)){
  ...
  if($gravaDados){
    ...
    if ($objClientes->atualizaCliente($_POST['nome'],$_POST['email'],$_POST['endereco'],$_POST['cep'],$_POST['bairro'],$_POST['cgc'], $_POST['numero'],
                                      $_POST['cidade'],$_POST['uf'],$_POST['fone1'],$id)){
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input id="password_1" type="password" class="form-control" name="senha">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-md-8">
                      <div class="form-group">
                        ...
                        <input id="firstname" type="text" class="form-control" name="nome" value="<?=$cliente->nome?>">
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-group">
                        <label for="firstname">CNPJ / CPF</label>
                        <input id="firstname" type="text" class="form-control cgc"  name="cgc" value="<?=$cliente->cgc?>">
                      </div>
                    </div>
                  </div>
                  <div class="row">                    
